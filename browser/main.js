...
var routes = [
  {
    path: "configuration",
    loadComponent: () => import("./chunk-RS52RPB3.js").then((m) => m.ConfigurationComponent)
  },
  {
    path: "board",
    loadComponent: () => import("./chunk-367LPGJE.js").then((m) => m.BoardComponent)
  },
  {
    path: "chart",
    loadComponent: () => import("./chunk-TVPWY7ZH.js").then((m) => m.ChartComponent)
  },
  {
    path: "circuit",
    loadComponent: () => import("./chunk-GMKMI3J6.js").then((m) => m.CircuitComponent)
  },
  {
    path: "archive",
    loadComponent: () => import("./chunk-6RZ6UFGB.js").then((m) => m.ArchiveComponent)
  },
  {
    path: "steering-wheel",
    loadComponent: () => import("./chunk-QWJ7UJON.js").then((m) => m.SteeringWheelComponent)
  },
  {
    path: "live-ranking",
    loadComponent: () => import("./chunk-BQJJNHOF.js").then((m) => m.LiveRankingComponent)
  },
  {
    path: "**",
    redirectTo: "board"
...
function extractFirestoreCollection(url) {
  const match = url.match(/documents\/([^\/]+)/);
  return match ? match[1] : "unknown collection";
}
var errorInterceptor = (req, next) => {
  ...
  return next(req).pipe(catchError((error2) => {
    ...
    if (url.includes("/api/")) {
      ...
      requestInfo = `${method} request to ${apiPath}`;
    } else if (url.includes("firestore") || url.includes("firebase")) {
      if (url.includes("documents")) {
        const collection = extractFirestoreCollection(url);
        requestInfo = `Firestore operation on ${collection}`;
      } else {
        requestInfo = `Firebase operation (${method})`;
      }
    } else if (url.includes("/lap")) {
      requestInfo = "Lap data operation";
    } else if (url.includes("/race")) {
      requestInfo = "Race data operation";
    } else if (url.includes("/driver")) {
      requestInfo = "Driver data operation";
    } else if (url.includes("/kart")) {
      requestInfo = "Kart data operation";
    } else if (url.includes("/team")) {
      requestInfo = "Team data operation";
    } else if (url.includes("/stint")) {
      requestInfo = "Stint data operation";
    } else if (url.includes("/tyre")) {
      requestInfo = "Tyre data operation";
    } else {
      requestInfo = `${method} request`;
    }
    switch (error2.status) {
      ...
      case 408:
        ...
        break;
      case 409:
        errorMessage = "Data conflict. The resource may have already been modified.";
        break;
      case 422:
        errorMessage = "Invalid data. Please check the entered fields.";
        break;
      case 429:
      ...
      default:
        if (error2.status >= 500) {
          ...
          errorMessage = "Request error. Please check the entered data.";
        }
    }
    if (error2.error?.message) {
      errorMessage = error2.error.message;
    } else if (error2.error?.error) {
      errorMessage = error2.error.error;
    } else if (typeof error2.error === "string") {
      errorMessage = error2.error;
    }
    const fullMessage = `${requestInfo}: ${errorMessage}`;
    notificationService.error(fullMessage, 8e3);
...
var appConfig = {
  providers: [
    ...
    provideDatabase(() => getDatabase2())
  ]
};

// src/app/shared/component/notification/notification.component.ts
function NotificationComponent_div_1__svg_svg_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275classMap(ctx_r2.getIconClasses(notification_r2.type));
  }
}
function NotificationComponent_div_1__svg_svg_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(0, "svg", 7);
    \u0275\u0275element(1, "path", 9);
...
function NotificationComponent_div_1__svg_svg_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(0, "svg", 7);
    \u0275\u0275element(1, "path", 10);
...
function NotificationComponent_div_1__svg_svg_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(0, "svg", 7);
    \u0275\u0275element(1, "path", 11);
...
function NotificationComponent_div_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, NotificationComponent_div_1__svg_svg_1_Template, 2, 2, "svg", 2)(2, NotificationComponent_div_1__svg_svg_2_Template, 2, 2, "svg", 2)(3, NotificationComponent_div_1__svg_svg_3_Template, 2, 2, "svg", 2)(4, NotificationComponent_div_1__svg_svg_4_Template, 2, 2, "svg", 2);
    \u0275\u0275elementStart(5, "div", 3);
    \u0275\u0275text(6);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "button", 4);
    \u0275\u0275listener("click", function NotificationComponent_div_1_Template_button_click_7_listener() {
      const notification_r2 = \u0275\u0275restoreView(_r1).$implicit;
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.onClose(notification_r2.id));
    });
    \u0275\u0275namespaceSVG();
  ...
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275classMap(ctx_r2.getNotificationClasses(notification_r2.type));
    \u0275\u0275advance();
...
var NotificationComponent = class _NotificationComponent {
  ...
  getNotificationClasses(type) {
    const baseClasses = "flex items-center flex-row gap-2 p-4 mb-2 rounded-lg shadow-lg transition-all duration-300 ease-in-out transform";
    switch (type) {
      case "success":
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _NotificationComponent, selectors: [["app-notification"]], decls: 2, vars: 2, consts: [[1, "fixed", "bottom-4", "right-4", "z-50", "max-w-xs", "sm:max-w-sm", "w-full"], [3, "class", 4, "ngFor", "ngForOf", "ngForTrackBy"], ["class", "w-5 h-5", "fill", "currentColor", "viewBox", "0 0 20 20", 3, "class", 4, "ngIf"], [1, "flex-1", "font-semibold"], ["type", "button", "aria-label", "Chiudi notifica", 1, "text-white", "hover:text-gray-200", "focus:outline-none", "focus:ring-2", "focus:ring-white", "focus:ring-opacity-50", "rounded-full", "p-1", "transition-colors", "duration-200", "hover:cursor-pointer", 3, "click"], ["fill", "currentColor", "viewBox", "0 0 20 20", 1, "w-4", "h-4"], ["fill-rule", "evenodd", "d", "M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z", "clip-rule", "evenodd"], ["fill", "currentColor", "viewBox", "0 0 20 20", 1, "w-5", "h-5"], ["fill-rule", "evenodd", "d", "M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z", "clip-rule", "evenodd"], ["fill-rule", "evenodd", "d", "M10 18a8 8 0 100-16 8 8 0 000 16zM8.707 7.293a1 1 0 00-1.414 1.414L8.586 10l-1.293 1.293a1 1 0 101.414 1.414L10 11.414l1.293 1.293a1 1 0 001.414-1.414L11.414 10l1.293-1.293a1 1 0 00-1.414-1.414L10 8.586 8.707 7.293z", "clip-rule", "evenodd"], ["fill-rule", "evenodd", "d", "M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z", "clip-rule", "evenodd"], ["fill-rule", "evenodd", "d", "M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z", "clip-rule", "evenodd"]], template: function NotificationComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 0);
      \u0275\u0275template(1, NotificationComponent_div_1_Template, 10, 7, "div", 1);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
      \u0275\u0275advance();
      \u0275\u0275property("ngForOf", ctx.notifications())("ngForTrackBy", ctx.trackByFn);
    }
  }, dependencies: [
    NgForOf,
    NgIf
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(NotificationComponent, [{
    ...
    args: [{ selector: "app-notification", standalone: true, imports: [
      NgForOf,
      NgIf
    ], template: `<!-- Notification Container - Fixed at bottom of screen -->
<div class="fixed bottom-4 right-4 z-50 max-w-xs sm:max-w-sm w-full">
  <div *ngFor="let notification of notifications(); trackBy: trackByFn"
    ...
    <!-- Close Button -->
    <button type="button"
            class="text-white hover:text-gray-200 focus:outline-none focus:ring-2 focus:ring-white focus:ring-opacity-50 rounded-full p-1 transition-colors duration-200 hover:cursor-pointer"
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(NotificationComponent, { className: "NotificationComponent", filePath: "src/app/shared/component/notification/notification.component.ts", lineNumber: 16 });
})();

// src/app/app.component.ts
function AppComponent_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "app-notification");
  }
}
var AppComponent = class _AppComponent {
  ...
  isSteeringWheelRoute() {
    return this.router.url.includes("/steering-wheel");
  }
  static \u0275fac = function AppComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _AppComponent)(\u0275\u0275directiveInject(Router));
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AppComponent, selectors: [["app-root"]], decls: 3, vars: 1, consts: [[1, "w-full", "h-full", "min-h-screen", "min-w-screen", "pb-2"]], template: function AppComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 0);
      \u0275\u0275element(1, "router-outlet");
      \u0275\u0275template(2, AppComponent_Conditional_2_Template, 1, 0, "app-notification");
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
      \u0275\u0275advance(2);
      \u0275\u0275conditional(!ctx.isSteeringWheelRoute() ? 2 : -1);
    }
  }, dependencies: [
    RouterOutlet,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(AppComponent, [{
    ...
    args: [{ selector: "app-root", imports: [
      RouterOutlet,
      NotificationComponent
    ], template: '<div class="w-full h-full min-h-screen min-w-screen pb-2">\n  <router-outlet/>\n\n  @if (!isSteeringWheelRoute()) {\n    <app-notification></app-notification>\n  }\n</div>\n' }]
  }], () => [{ type: Router }], null);
})();
(() => {
